...
function toggleDark() {
    ...
    if (document.body.classList.contains('darkTheme')) {
        icon.src = image.image_url + "/assets/images/dark-logo.png";
        adImage.src = image.image_url + "/assets/images/dark-ads-space.png";
        darkLogo.src = image.image_url + "/assets/images/sunny.png";
    } else {
        icon.src = image.image_url + "/assets/images/logo.png";
        adImage.src = image.image_url + "/assets/images/ads-space.png";
        darkLogo.src = image.image_url + "/assets/images/moon.png";
